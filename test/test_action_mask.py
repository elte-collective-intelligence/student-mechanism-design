...
def test_action_mask_respects_budget_and_mapping():
    ...
    result = compute_action_mask(adjacency, current_node=0, budget=3, edge_weights=edge_weights)
...
def test_action_mask_with_scalar_toll():
    ...
    assert result.mask.sum() == 0, "No moves should be affordable with budget 0.5 and cost 1.25"
...
def test_action_mask_no_valid_moves():
    ...
    result = compute_action_mask(adjacency, current_node=0, budget=1, edge_weights=edge_weights)
