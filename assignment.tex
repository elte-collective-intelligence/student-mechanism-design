...
\usepackage[a4paper, top=2.5cm, bottom=2.5cm, left=3cm, right=3cm, headheight=36.5pt, footskip=1.5cm]{geometry}
...
% Section formatting
\setkomafont{section}{\LARGE\bfseries\color{primaryblue}}
\setkomafont{subsection}{\Large\bfseries\color{secondaryblue}}
\setkomafont{subsubsection}{\large\bfseries\color{darkgray}}
...
\ihead{%
  \raisebox{-2pt}{\includegraphics[height=1.2cm]{images/logo.png}}
}
\ohead{\textcolor{darkgray}{\textbf{Mechanism Design Assignment}}}
\cfoot{\textcolor{darkgray}{\pagemark}}
...
% - Title and authors -
\title{\Huge \textbf{\textcolor{primaryblue}{Scotland Yard}}\\[0.3em]
\LARGE \textcolor{darkgray}{Multi-Agent Mechanism Design}}

\author{
\textcolor{darkgray}{Collective Intelligence -- Spring 2026}
}
\date{\textcolor{darkgray}{Teams of 2-3 students | 6-8 weeks}}
...
\begin{center}
    \includegraphics[width=0.5\textwidth]{images/scotland_yard.png}
\end{center}
...
\begin{tcolorbox}[modern, colframe=primaryblue, title=\textcolor{white}{\textbf{What is already provided}}, coltitle=white, colbacktitle=primaryblue]
...
\begin{tcolorbox}[modern, colframe=accentgreen, title=\textcolor{white}{\textbf{Teams \& Timeline}}, coltitle=white, colbacktitle=accentgreen]
\begin{itemize}[leftmargin=1.2em, itemsep=4pt]
    ...
    \item \textbf{Tasks are independent} -- no inter-team dependencies
\end{itemize}
\end{tcolorbox}
...
\begin{enumerate}[leftmargin=1.4em]
    \item \textbf{Population Manager} (\texttt{src/training/population\_trainer.py}):
    \begin{itemize}
    ...
    \item \textbf{Exploitability Testing} (\texttt{src/eval/exploitability.py} extension):
    \begin{itemize}
...
\begin{itemize}[leftmargin=1.2em]
    ...
    \item Store population in \texttt{src/artifacts/populations/}
    \item Config: \texttt{src/configs/training/population.yaml} with pool sizes, matchmaking strategy
...
\begin{enumerate}[leftmargin=1.4em]
    ...
    \begin{itemize}
        \item \texttt{src/agent/gat\_agent.py}: Graph Attention Networks (PyTorch Geometric)
        \item \texttt{src/agent/transformer\_agent.py}: Transformer with positional encoding on graphs
        \item Follow same interface as \texttt{GNNAgent} (inherit from \texttt{BaseAgent})
    \end{itemize}
    
    \item \textbf{Ablation Study} (\texttt{src/eval/architecture\_ablations.py}):
    \begin{itemize}
...
\begin{itemize}[leftmargin=1.2em]
    ...
    \item Configs: \texttt{src/configs/agent/gat.yaml}, \texttt{transformer.yaml}
...
\subsubsection*{Implementation Requirements}
\begin{enumerate}[leftmargin=1.4em]
    \item \textbf{Priority Edge System} (\texttt{src/environment/graph\_generator.py} extension):
    \begin{itemize}
    ...
    \item \textbf{Multi-Objective Rewards} (\texttt{src/environment/multi\_objective\_reward.py}):
    \begin{itemize}
...
\begin{itemize}[leftmargin=1.2em]
    ...
    \item Config: \texttt{src/configs/environment/priority\_edges.yaml}
...
\begin{tcolorbox}[modern, colframe=darkgray, leftrule=4pt]
...
\begin{tcolorbox}[modern, colframe=accentorange, title=\textcolor{white}{\textbf{Total: 100 points}}, coltitle=white, colbacktitle=accentorange]
...
\begin{tcolorbox}[modern, colframe=secondaryblue, leftrule=4pt]
\begin{itemize}[leftmargin=1.2em, itemsep=4pt]
    ...
    \item \textbf{Artifacts}: Include plots/GIFs in \texttt{src/artifacts/semester\_contribution/}
...
\vspace{0.5em}
\noindent\textcolor{darkgray}{\textbf{Prepared by:}} Tamás Takács \\
\textcolor{darkgray}{\textbf{Semester:}} 2025/26/2

\vspace{1em}
\begin{center}
    \footnotesize\textcolor{gray}{Licensed under \href{https://creativecommons.org/licenses/by-nc-nd/4.0/}{CC BY-NC-ND 4.0}. \copyright~Tamás Takács, 2025.}
\end{center}
